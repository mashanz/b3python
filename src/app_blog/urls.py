...
urlpatterns = [
    ...
    path("api/id/<str:posts_id>", views.apis.posts_read_one),       # GET one data           -> /id/(123)
    path("api/create", views.apis.posts_create),                    # POST one data          -> /(create)
    path("api/id/<str:posts_id>/update", views.apis.posts_update),  # PATCH one data         -> /id/(123)/update
    path("api/id/<str:posts_id>/delete", views.apis.posts_delete),  # DELETE one data        -> /id/(123)/delete
