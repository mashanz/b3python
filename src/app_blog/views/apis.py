...
def posts_create(request):
    ...
    return JsonResponse({"method": "POST", "description": "CREATE"})
...
def posts_update(request, posts_id):
    return JsonResponse(
        {"method": "PATCH", "description": "UPDATE DATA", "data": posts_id}
    )
...
def posts_delete(request, posts_id):
    return JsonResponse(
        {"method": "DELETE", "description": "DELETE DATA", "data": posts_id}
    )
